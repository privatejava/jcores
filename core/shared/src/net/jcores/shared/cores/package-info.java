 ...
 * {@link net.jcores.shared.CoreKeeper} (accessible as <code>$</code>, also see the 
 ...
 * 
 * which returns a {@link net.jcores.shared.cores.CoreObject}. The <code>$</code>-function always picks the most suitable {@link net.jcores.shared.cores.Core} 
 * (better said: subclass of Core) for the elements you passed. Similar to the example above, 
 * when you call<br/><br/>
 * 
 * <code>$("a", "b", "c")</code><br/><br/>
 * 
 * a {@link net.jcores.shared.cores.CoreString} will be returned. In addition to the the cores in this package
 * also have a look at the {@link net.jcores.shared.CommonCore} (accessible through <code>$</code> as well), 
